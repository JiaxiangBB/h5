...
var img=imgSRC+'/login/2_2.png';
document.getElementById('smtVerify').innerHTML="<a class='smtk' href=\"javascript:vrsn_splash()\" tabindex=\"-1\"><img name=\"seal\" style=\"width:75px;height:33px\" border=\"true\" src='"+img+"'/></a>";
